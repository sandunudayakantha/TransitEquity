...
const AdminPanel = ({ user, onLogout }) => {
  return (
    <AdminLayout user={user} onLogout={onLogout} eyebrow="Operations overview" title="Dashboard">
      <section className="rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top_right,_rgba(56,189,248,0.18),_transparent_35%),linear-gradient(135deg,_rgba(15,23,42,0.95),_rgba(30,41,59,0.9))] p-8 shadow-2xl">
